...
export const generateVisualConcept = async (concept: string) => {
  ...
  if (!candidates || candidates.length === 0) throw new Error("No response generated by the AI.");
  ...
  if (!imageUrl && !explanation) throw new Error("The AI returned an empty result.");
